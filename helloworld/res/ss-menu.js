...
function LoadingSSProgress(seconds) {
	...
	if (action == 0) {
		...
		$("#loading_block2").html("<li><font color='#ffcc00'><a href='https://github.com/zusterben/plan_b' target='_blank'></font>插件工作有问题？请到<em>GITHUB</em>提交issue...</font></li>");
	} else if (action == 1) {
...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/zusterben/plan_b/master/history_package/"+scarch+"helloworld_1.5.7.tar.gz";
		...
		statusmenu += "</br>回滚其它版本号，请参考<a href='https://github.com/zusterben/plan_b/' target='_blank'><u><font color='#00F'>版本历史列表</font></u></a>";
		_caption = "helloworld for merlinR 版本";
	} else if (itemNum == 13) {
		...
		statusmenu = "helloworld规则更新包括了gfwlist模式中用到的<a href='https://github.com/zusterben/plan_b/blob/master/rules/gfwlist.conf' target='_blank'><font color='#00F'><u>gfwlist</u></font></a>，在大陆白名单模式和游戏模式中用到的<a href='https://github.com/zusterben/plan_b/blob/master/rules/chnroute.txt' target='_blank'><u><font color='#00F'>chnroute</font></u></a>和<a href='https://github.com/zusterben/plan_b/blob/master/rules/cdn.txt' target='_blank'><u><font color='#00F'>国内cdn名单</font></u></a>"
		statusmenu += "</br>建议更新时间在凌晨闲时进行，以避免更新时重启ss服务器造成网络访问问题。"
		_caption = "helloworld规则自动更新";
	} else if (itemNum == 45) {
		...
		statusmenu = "插件触发重启设定说明：<br />&nbsp;&nbsp;&nbsp;&nbsp;当你的ss/ssr/v2ray服务器，或者负载均衡服务器节点使用域名的时候，可以在此处设定定时解析域名时间，当检测到相应的解析地址发生改变的时候，定时任务会自动重启插件，以应用新的ip地址。<br />&nbsp;&nbsp;&nbsp;&nbsp;服务器有多个解析地址的建议不要使用！！v2ray开了cdn的也建议不要使用！！因为这可能会导致每次检测到的ip都不一样而让插件在后台频繁重启！"
		_caption = "说明：";
	} else if (itemNum == 110) {
